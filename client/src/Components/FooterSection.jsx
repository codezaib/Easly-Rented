...
const FooterSection = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white pt-12 relative">
      ...
      <button
        onClick={scrollToTop}
        className="absolute bottom-5 cursor-pointer right-3 md:right-1/2 bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-full transition transform md:translate-x-1/2"
